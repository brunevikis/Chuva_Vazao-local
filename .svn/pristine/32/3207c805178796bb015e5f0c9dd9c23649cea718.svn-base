...
namespace ChuvaVazaoTools {
    public partial class TempViewer : Form {
        ...
        {
            if (this.chart1.ChartAreas[0].AxisY.Maximum < 50)
            {
        ...
        {
            if (this.chart1.ChartAreas[0].AxisY.Maximum > 5)
            {
                this.chart1.ChartAreas[0].AxisY.Maximum -= 5;
                RefreshView();
            }
        ...
        private void btn_InterUp_Click(object sender, EventArgs e)
        {
            if (this.chart1.ChartAreas[0].AxisY.Interval < 5)
            {
        ...
        private void btn_InterDown_Click(object sender, EventArgs e)
        {
            if (this.chart1.ChartAreas[0].AxisY.Interval > 1)
            {
                this.chart1.ChartAreas[0].AxisY.Interval -= 1;
                RefreshView();
            }
        ...
        private void btn_defaulChart_Click(object sender, EventArgs e)
        {
            this.chart1.ChartAreas[0].AxisY.Maximum = 35;
