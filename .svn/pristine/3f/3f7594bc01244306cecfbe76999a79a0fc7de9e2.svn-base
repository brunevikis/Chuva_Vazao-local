...
namespace ChuvaVazaoTools.SMAP
{
    ...
    public class ModeloSmap : ModeloChuvaVazao
    {
        ...
        public ModeloSmap(string path)
        {
            ...
            System.IO.File.ReadLines(caso)
                ...
                {
                    var subbaciaNome = x;
                    var subbacia = new SubBacia(path, subbaciaNome);
                    return subbacia;
                }).ToList();
            ...
            foreach (var posto in PostosPlu)
            {
                ...
                {
                    posto.Carregar(existingFiles[0]);
                    posto.l1 = "";
                }
            }
    ...
    public class SubBacia : IArqVazao
    {
        ...
        public SubBacia(string path, string subbacia)
        {
            ...
            vazRealizadas = new VazoesRealizadas(System.IO.Path.Combine(ArquivosDeEntrada, Nome + ".txt"));
