...
file.xlsx <- "P:/Pedro/remoção_R/Contornos/Configuracao_madeira.xlsx"
caminhocontornos <- paste0("P:/Pedro/remoção_R/Contornos/", ifelse(grade =="GEFS", "GEFS/contornos TIGGE_GFS_", "ETA40/"))
