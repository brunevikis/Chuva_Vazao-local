    ...
    public class cptec
    {
        ...
        public static void GetApiTempoTESTE(DateTime data)
        {
            ...
            for (DateTime dia = data.AddDays(-7); dia <= data; dia = dia.AddDays(1))
            {
                ...
                var directoryToSaveGif = @"P:\Trading\Acompanhamento Metereologico Semanal\spiderman\" + data.ToString("yyyy_MM_dd") + @"\OBSERVADO_INMET";
        ...
        public static Dictionary<Tuple<decimal, decimal>, float> GetApiTempo(DateTime data, string lateFunc)
        {
            ...
            var directoryToSaveGif = @"P:\Trading\Acompanhamento Metereologico Semanal\spiderman\" + data.ToString("yyyy_MM_dd") + @"\OBSERVADO";
        ...
        public static string DownloadECMWF(DateTime dt, System.IO.TextWriter log = null, string horasToDownload = "00;12")
        {
            ...
            var directoryToSaveGif = @"P:\Trading\Acompanhamento Metereologico Semanal\spiderman\" + dt.ToString("yyyy_MM_dd") + @"\ECMWF_ONS";
